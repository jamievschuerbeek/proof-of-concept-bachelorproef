			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hogent-display": {
								"semanticObject": "hogent",
								"action": "display",
								"description": "Bachelorproef POC project",
								"title": "Bachelorproef",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hogent",
									"url": sap.ui.require.toUrl("hogent")
								}
							}
						}
					}
